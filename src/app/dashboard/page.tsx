...
export default function Page() {
  return (
    <div className="flex bg-[#F6F7F9]">
      ...
      <div className="overflow-auto pb-6 h-full mt-4 ">
        <ul className="space-y-1">
          ...
          <li>
            <a href="javascript:void(0)"
              className="text-black hover:text-white text-[15px] flex items-center hover:bg-[#3563E9] rounded px-4 mt-40 pt-3 pb-3 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
    ...
    <div className="w-[534px] h-[836px] bg-white m-3">
        <h2 className="text-[20px] m-4 text-[#1A202C]">
            Detail Rental
        </h2>
        <Image
        src="/Maps.png"
        ...
        className=" m-4 "
        />
        <h2 className=" m-4">Nissan GT - R 
            <span>Sport Car</span></h2>
            <h3 className="ml-24 mt-4 flex justify-end">#9761</h3>
        {/* hey */}
  ...
  <div className="flex flex-col justify-center items-center space-y-4 lg:flex-row lg:space-y-0 lg:space-x-4">
    {/* Pick-Up Section */}
   <div className=" block">
    <div className="p-4 w-[500] bg-white h-auto rounded-xl lg:w-[490px] lg:h-40">
  ...
  <div className="w-full flex">
    <div className="w-2/4">
        ...
        <h2 className="text-[14px]  text-[#90A3BF]">Overall price and includes rental discount</h2>
